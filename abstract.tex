...
These together produce population nonlinearities, which results in a neural network that exhibits many desirable coding properties, including improved robustness, selectivity, and efficiency when compared to more traditional architectures.
...
This has encouraged scientists to use it as a testing ground for hypotheses stemming from important theories for neural computation.
% a model for (a means to explore / exploring) (possible accounts / the consequences of) neural coding models / to observe neurophysiological phenomena
% conseptualizing what's going on / framework for conceptualize theories of neural coding and explore their consequences 
% test bed for ideas
% model that you can explore/ perturb/ elaborate  in various ways to see how it can account for neural phenomena or account for consequences
