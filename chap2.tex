...
\begin{figure}\label{fig:ch2_lca_overcompleteness_tiling}
    \centering
...
\begin{figure}\label{fig:ch2_lca_inference_traces}
    \centering
...
\begin{figure}\label{fig:ch2_lca_fixed_point_distances}
    \centering
    \includegraphics[width=0.5\textwidth{figures/lca_fixed_point_distances.png}
...
\begin{figure}\label{fig:ch2_lca_norms_and_acc}
    \centering
