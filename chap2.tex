...
%TODO: this figure caption references preprocessing appendix which does not exist
...
%%% TODO
%% Fix hamming distance for l0 sampling project
%% Angle histograms
...
% BF learned with ICA vs complete LCA ; LCA is still non-linear encoding when complete.
