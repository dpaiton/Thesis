...
%TODO: Should these be f(a), etc? this is the functional form of the PDF right? so f(x) instead of P(x)? actually they should be little ps bc little p is a density function
...
% TODO: make spatial freq (top) half plane instead of quarter
\begin{figure}[ht]
    \centering
