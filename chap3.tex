\chapter{Hierarchical extensions of the LCA}

%TODO: Tell a better story here, maybe read a bunch of abstracts?
...
%TODO: redo weight images to be on the same scale, make weights bigger & hist smaller
\begin{figure}[h]
    \centering
