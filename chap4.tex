\chapter{Iso-Response Contours Explain Adversarial Robustness, Efficiency, and Selectivity}
...
%TODO:
%\subsection{new experiments}\label{sec:ch4_}
%New experiment figures that we discussed with charles & bruno
...
%TODO: 
%\subsubsection{LCA is robust against trasferred adversarial attacks}
...
\subsubsection{Replacing the first layer of an MLP with LCA boosts robustness}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{figures/orientation_selectivity.png}
