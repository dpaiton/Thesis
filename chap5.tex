...
%TODO:
% Lessons learned
% a little more visionary
% unify the thesis
% what is the grand new direction to take it
...
In chapter 1, we noted that there are many important brain processing areas that are largely ignored in the sparse coding model. %TODO: Fix chapter refs
...
In chapter 2 we noted that deriving a locally-connected variant of the LCA would be a valuable contribution \parencite{le2011building, ngiam2010tiled}. %TODO: Fix chapter refs
...
In chapter 3 we proposed a hierarchical model for producing invariant representations of natural scenes and we provide promising steps towards the achieving model. %TODO: Fix chapter refs
...
In chapter 4 we describe and extend a method for geometrically describing the selectivity and invariance of neurons. %TODO: Fix chapter refs
We measured selectivity to changing orientation for various neuron models, but, as we outlined in chapter 2, the LCA learns receptive fields that also tile spatial frequency and position. %TODO: Fix chapter refs
...
We believe adapting the iso-response contour and adversarial analyses to include the LCA variant that has feedback signals (defined in chapter 3) would also be an exciting direction for future work. %TODO: Fix chapter refs
